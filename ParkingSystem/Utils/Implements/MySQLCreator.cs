        ...
        public override void UpdateDatabase()
        {
            try
            {
                ...
                if (versaoBanco < 3)
                {
                    ...
                    ExecuteSql("CREATE TABLE IF NOT EXISTS MODELOS(ID INT NOT NULL AUTO_INCREMENT, IDFABRICANTE INT NOT NULL, NOME VARCHAR(100) NOT NULL, POTENCIA DECIMAL NOT NULL, ANO INT NOT NULL, PRIMARY KEY(ID))");
