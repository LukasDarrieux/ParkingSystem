        ...
        public override void UpdateDatabase()
        {
            try
            {
                ...
                if (versaoBanco < 3)
                {
                    ...
                    sql = "CREATE TABLE MODELOS(ID INT NOT NULL IDENTITY(1,1), IDFABRICANTE INT NOT NULL, NOME VARCHAR(100) NOT NULL, MOTOR VARCHAR(20) NOT NULL, ANO INT NOT NULL, PRIMARY KEY(ID))";
